...
void MyMap::createActions() {
    ...
    connect(newMapAction, &QAction::triggered, this, &MyMap::onNewMap);
    ...
    connect(openGeoJsonMineAction, &QAction::triggered, this,
            &MyMap::onOpenGeoJsonMine);
    connect(openGeoJsonUsingGDALAction, &QAction::triggered, this,
            &MyMap::onOpenGeoJsonUsingGDAL);
    connect(openShapfileAction, &QAction::triggered, this,
            &MyMap::onOpenGeoShapefile);
    connect(openTiffAction, &QAction::triggered, this, &MyMap::onOpenTiff);
    ...
    connect(showLogDialog, &QAction::triggered, this, &MyMap::onShowLogDialog);

    // menu: About
    aboutAction = new QAction(tr("About MyMap"), this);
    aboutAction->setIcon(QIcon(""));
    aboutMenu->addAction(aboutAction);
    connect(aboutAction, &QAction::triggered, this, &MyMap::onAbout);
}


// layout
void MyMap::setupLayout() {
...
// menu: file->open->GeoJson
// Method2: Using GDAL
void MyMap::onOpenGeoJsonUsingGDAL() {
    QStringList files = QFileDialog::getOpenFileNames(
        this, tr("Open File"), "", tr("json files(*.json)"), nullptr,
        QFileDialog::DontUseNativeDialog);
...
void MyMap::onConnectPostgresql() {
...
void MyMap::closeEvent(QCloseEvent *event) {
